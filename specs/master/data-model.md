# Data Model: Humanoid Robotics Documentation Structure

## Overview
This document defines the data model for the humanoid robotics documentation system implemented using Docusaurus.

## Content Entities

### Module
- **name**: String - The name of the module (e.g., "Introduction to Humanoid Robotics", "The Digital Twin")
...
- **type**: String - Type of content (text, code, image, exercise)
