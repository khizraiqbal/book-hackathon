# Data Model: NVIDIA Isaac Module Documentation Structure

## Overview
This document defines the data model for the NVIDIA Isaac module documentation system implemented using Docusaurus.

## Content Entities

### Module
- **name**: String - The name of the module (e.g., "The AI-Robot Brain (NVIDIA Isaac™)")
